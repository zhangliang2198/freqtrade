...
class PairListManager(LoggingMixin):
    def __init__(self, exchange, config: Config, dataprovider: DataProvider | None = None) -> None:
        ...
        self._selection_whitelist = (self._whitelist or []).copy()
    ...
    @property
    def selection_whitelist(self) -> list[str]:
        """The latest whitelist generated by the pairlist handlers"""
        return self._selection_whitelist.copy()
    ...
    def refresh_pairlist(self, only_first: bool = False, pairs: list[str] | None = None) -> None:
        ...
        self._selection_whitelist = pairlist.copy()
