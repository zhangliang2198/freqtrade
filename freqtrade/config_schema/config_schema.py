...
CONF_SCHEMA = {
    ...
    "properties": {
        "exchange_accounting": {
            "description": "Reconcile Binance futures fills and funding.",
            "type": "object",
        ...
        "manual_position_sync": {
            "description": "Reconcile manual futures positions and protective stops.",
            "type": "object",
            "additionalProperties": False,
            "properties": {
                "enabled": {"type": "boolean", "default": False},
                "import_positions": {"type": "boolean", "default": True},
                "auto_exit_positions": {
                    "description": "Allow strategy-initiated exits; protection is independent.",
                    "type": "boolean",
                },
                "auto_manage_positions": {
                    "description": "Deprecated alias for auto_exit_positions.",
                    "type": "boolean",
                },
                "manage_protective_stops": {"type": "boolean", "default": True},
                "cleanup_orphan_stops": {"type": "boolean", "default": True},
                "interval_seconds": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                    "default": 60,
                ...
                "orphan_stop_interval_seconds": {
                    "description": "Interval between account-wide orphan stop scans.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                    "default": 900,
                },
        ...
        "telegram": {
            ...
            "properties": {
                "proxy_url": {
                    "description": "Proxy URL used for Telegram requests and update polling.",
                    "type": "string",
                    "minLength": 1,
                },
                "connect_timeout": {
                    "description": "Telegram connection timeout in seconds.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                },
                "read_timeout": {
                    "description": "Telegram response read timeout in seconds.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                },
                "write_timeout": {
                    "description": "Telegram request write timeout in seconds.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                },
                "pool_timeout": {
                    "description": "Telegram connection-pool wait timeout in seconds.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                },
                "polling_restart_seconds": {
                    "description": "Delay before restarting a stopped Telegram updater.",
                    "type": "number",
                    "exclusiveMinimum": 0,
                    "default": 5,
                },
